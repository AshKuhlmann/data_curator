...
def test_scan_wrapper(mock_core):
    ...
    cli.handle_scan("/tmp/repo", "filter")
...
def test_set_status_wrapper(mock_core):
    ...
    cli.handle_set_status("/tmp/repo", "file.txt", "keep_forever")
...
def test_rename_wrapper(mock_core):
    ...
    cli.handle_rename("/tmp/repo", "old.txt", "new.txt")
...
def test_delete_wrapper(mock_core):
    ...
    cli.handle_delete("/tmp/repo", "file.txt")
...
@patch("data_curator_app.cli.handle_scan")
